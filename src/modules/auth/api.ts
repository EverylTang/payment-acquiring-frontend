...
export type AccessMenu = { id: number; parentId: number; menuCode: string; menuName: string; menuType: string; routePath: string | null; componentKey: string | null; icon: string | null; sortOrder: number };
...
export const changePassword = (currentPassword: string, newPassword: string) =>
  request<void>("/admin/v1/auth/change-password", {
    method: "POST",
