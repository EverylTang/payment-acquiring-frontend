...
export const executeRefund = (orderId: string, refundId: string) => request<Refund>(`/v1/payments/orders/${encodeURIComponent(orderId)}/refunds/${encodeURIComponent(refundId)}/execute`, { method: "POST" });
