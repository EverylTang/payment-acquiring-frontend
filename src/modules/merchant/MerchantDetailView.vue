...
import { getActiveCountries, type Country } from "../master-data/api";
...
onMounted(async () => { countries.value = await getActiveCountries(); await load(); });
</script>
